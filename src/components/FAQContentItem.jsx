    ...
    return (
        <section className={"flex flex-col gap-6"}>
            ...
            <button type={"button"} className={"flex items-center justify-between"}>
                <h3 aria-controls={"answer"} aria-expanded="false" aria-labelledby={"question"} tabIndex={0} onClick={onOpenAnswer} className={`text-preset-2 font-preset-2 leading-preset-2 hover:text-violet-600 cursor-pointer`}>{item.question}</h3>
